...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference("Library.count") do
      post libraries_url, params: { library: { author: @library.author, description: @library.description, pontuation: @library.pontuation, title: @library.title } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { author: @library.author, description: @library.description, pontuation: @library.pontuation, title: @library.title } }
